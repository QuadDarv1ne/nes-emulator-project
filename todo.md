...
- [ ] Протестировать загрузку ROM в dev-режиме
...
- [ ] Исправить обработку ошибок в `cartridge.ts` (парсинг iNES ROM)
...
- [ ] Завершить реализацию PPU (рендеринг спрайтов, background)
