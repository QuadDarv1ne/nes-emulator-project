...
<div align="center">
  <img src="./public/screenshots/main.png" alt="Главная страница" width="800" />
  <p><em>Главная страница приложения</em></p>
</div>

> 📷 **Примечание:** Добавьте скриншоты проекта в папку `public/screenshots/`:
> - `main.png` — главная страница
> - `gameplay.png` — игровой процесс
> - `settings.png` — настройки
> - `library.png` — библиотека игр
...
- 🌍 **i18n** — русский и английский языки (next-intl)
